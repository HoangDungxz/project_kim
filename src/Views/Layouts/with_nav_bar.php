                                                    ...
                                                    <figure class="card-figure">
                                                        ...
                                                        <figcaption class="prod-desc">
                                                            ...
                                                            <div class="buttons-wrapper">
                                                                <a href="#/sample-french-connection-straw-bag/" class="btn btn-primary btnATC" data-product-id="74" title="Choose Options" data-event-type="product-click"><span>Choose
                                                                        Options</span></a>
                                                            </div>
                                                        </figcaption>
                                                    </figure>
                                                ...
                                                <article class="card ">
                                                    <figure class="card-figure">
                                                        ...
                                                        <figcaption class="prod-desc">
                                                            ...
                                                            <div class="buttons-wrapper">
                                                                <a href="#/sample-french-connection-sunday-bliss-bag/" class="btn btn-primary btnATC" data-product-id="73" title="Choose Options" data-event-type="product-click"><span>Choose
                                                                        Options</span></a>
                                                            </div>
                                                        </figcaption>
                                                    </figure>
                                                ...
                                                <article class="card ">
                                                    <figure class="card-figure">
                                                        ...
                                                        <figcaption class="prod-desc">
                                                            ...
                                                            <div class="buttons-wrapper">
                                                                <a href="#/ben-sherman-bw-striped-long-sleeve-tee/" class="btn btn-primary btnATC" data-product-id="47" title="Choose Options" data-event-type="product-click"><span>Choose
                                                                        Options</span></a>
                                                            </div>
                                                        </figcaption>
                                                    </figure>
                                                ...
                                                <article class="card ">
                                                    <figure class="card-figure">
                                                        ...
                                                        <figcaption class="prod-desc">
                                                            ...
                                                            <div class="buttons-wrapper">
                                                                <a href="#/cart.php?action=add&amp;product_id=54" class="btn btn-primary btnATC themevale_btnATC" title="Thêm vào giỏ hàng" data-event-type="product-click" data-product-id="54"><span>Thêm vào giỏ hàng</span></a>
                                                            </div>
                                                        </figcaption>
                                                    </figure>
                                                </article>
                                                ...
                                                <article class="card ">
                                                    <figure class="card-figure">
                                                        ...
                                                        <figcaption class="prod-desc">
                                                            ...
                                                            <div class="buttons-wrapper">
                                                                <a href="#/sample-anna-multi-colored-bangles/" class="btn btn-primary btnATC" data-product-id="33" title="Choose Options" data-event-type="product-click"><span>Choose
                                                                        Options</span></a>
                                                            </div>
                                                        </figcaption>
                                                    </figure>
