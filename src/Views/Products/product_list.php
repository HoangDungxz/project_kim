   <main class="page-content col-sm-9">
       ...
       <div class="tags-search row">
           <div class="tag-item">
               <button type="button" value="" class="btn-tag-price btn btn-outline-dark"> <span
                       class="tag-price"></span>
               </button>
           </div>
           <div class="tag-item">
               <button type="button" value="" class="btn-tag-brand btn btn-outline-dark"> <span
                       class="tag-brand"></span>
               </button>
           </div>
       </div>
                                   ...
                                   <figcaption class="prod-desc">
                                       ...
                                       <div class="buttons-wrapper">
                                           ...
                                           <a href="/wishlist.php?action=add&amp;product_id=68" class="btnWL"
                                               title="Thêm vào yêu thích"><i class="fa fa-heart"></i><span>Thêm vào yêu
                                                   thích</span></a>
           ...
           <div class="product-pagination bottom">
               ...
               <div class="pagination">
                   <ul class="pagination-list">
                       ...
                       <li class="pagination-item pagination-item-page"><button type="button"
                               page='<?= $i ?>'><span><?= $i ?></span></button></li>
                       <?php endfor; ?>
