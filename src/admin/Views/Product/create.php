                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input value="<?= isset($user) ? $user->getName() : '' ?>" type="text" name="price" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-2">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input value="<?= isset($user) ? $user->getName() : '' ?>" type="text" name="discount" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
